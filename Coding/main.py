...
import BananaBoat, Krill, CoralAGAIN, remotecontrol
...
codeslist = [("1", Color.RED, BananaBoat.code1), ("2", Color.BLUE, Krill.code2), ("3", Color.GREEN, CoralAGAIN.code3), ("R", Color.WHITE, remotecontrol.remotecode)]
